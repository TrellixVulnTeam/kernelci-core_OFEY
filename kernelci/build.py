...
class Step:
    ...
    def __init__(self, kdir, output_path=None, log=None, reset=False, install_path=None):
        ...
        *reset* is whether the meta-data should be reset in this step
        ...
        self._install_path = self.get_install_path(kdir, self._output_path, install_path)
